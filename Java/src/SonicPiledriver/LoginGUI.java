    ...
    public LoginGUI() {
        ...
        ActionListener loginListener = new ActionListener() {
            public void actionPerformed(ActionEvent e) {
                ...
                boolean verifyBoolean = db.isValid(username.getText(), passwordstring);
                if (verifyBoolean == true) { 
                    VoIPGUI client = new VoIPGUI(username.getText());
                } else {
                    username.setText("");
                    password.setText("");
                    JOptionPane invalid = new JOptionPane("Invalid username or password.");
                }
                //db.killDB();
                }
                catch(Exception ex){
